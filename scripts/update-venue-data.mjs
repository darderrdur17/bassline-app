...
function updateAppVenueImages(mappings) {
  console.log('📱 Updating app venueImages.js...');
...
`;
  ...
  console.log(`   ✓ Updated ${sortedKeys.length} venue image mappings`);
}

// Update app venues.js
function updateAppVenues(mappings) {
  console.log('📱 Updating app venues.js...');
  ...
  console.log(`   ✓ Updated app venues.js`);
}

// Update web venues.ts
function updateWebVenues(mappings) {
  console.log('🌐 Updating web venues.ts...');
  ...
  console.log(`   ✓ Updated web venues.ts`);
}

// Main function
function main() {
  console.log('🔄 Updating venue data files...\n');

  if (!fs.existsSync(MAPPINGS_PATH)) {
    console.error('❌ Error: .venue-image-mappings.json not found. Run sync-venue-images.mjs first.');
    process.exit(1);
  }
